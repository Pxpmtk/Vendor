...
<div class="container">
            <div class="header" img src="images/skybg.jpg">
				<nav class="menu" tabindex="0">
                    ...
                    <ul>
					<a href="home.php"><li class="icon-home"><span>Home</span></li></a>
					<a href="add_new.php"><li tabindex="0" class="icon-text-document"><span>Add New</span></li></a>
					<a href="approve.php"><li tabindex="0" class="icon-check"><span>Approve</span></li></a>
					<a href="view.php"><li tabindex="0" class="icon-clocks"><span>View</span></li></a>
